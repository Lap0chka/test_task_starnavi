...
class PostViewSetTest(APITestCase):
    ...
    def test_retrieve_post_with_comments(self) -> None:
        ...
        Comment.objects.create(
            post=self.post, author=self.other_user, body="Second comment"
        )
    ...
    def test_comments_in_date_range_success(self) -> None:
        ...
        self.assertNotIn(
            ...
            [comment["body"] for comment in response.data["comments"]],
        )
    ...
    def test_amount_block_comment(self) -> None:
        for _ in range(3):
            try:
                Comment.objects.create(
                    post=self.post,
                ...
                pass
        self.assertEqual(self.post.amount_block_comment, 3)

    def test_send_celery_task(self) -> None:
        self.post.auto_response_comment = "Hi there thank your for comment"
        self.post.time_response = 1
        self.post.save()
        ...
        last = Comment.objects.first()
        self.assertEqual(last.body, self.post.auto_response_comment)
